# Add this two arrays and print result
# Find out which elements are in array1 and array2
# Sort the array1, with rule, that number 3 is bigger than everything else

array1 = [1,2,3,4,5]
array2 = [5,7,8,9]

# Make new array which consists of 10 random numbers (Math.rand)
array1 = []
